...
function buildDirectiveQueue({
  ...
  if (currentStage === 'tomorrow' && !sessionState.tomorrow_commitment) {
    ...
    if (rate !== null && rate < 50) {
      ...
      minimumFraming = `Their commitment confidence has been scoring ${Math.round(avgScore)}/100 and declining — they keep setting bars too high and missing them. Ask: "What are all the things you'd bet your life on finishing tomorrow to make it a productive day?" Bet-your-life framing forces real commitment, not hopeful thinking.`;
...
- First capture the full floor commitment with this exact intent: "Let's build out tomorrow. What are all the things that, if you got them done, would make tomorrow a real win — the floor you wouldn't fall below?" Store it in extracted_data.commitment_minimum.
